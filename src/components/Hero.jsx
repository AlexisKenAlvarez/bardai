                ...
                <section className='w-full h-screen bg-hero relative text-white overflow-hidden'>
                    ...
                    <div className='w-full max-w-[1700px] mx-auto flex items-center h-full lg:px-20 z-10 relative text-center lg:text-left justify-center lg:justify-start'>
                        <div>
                            ...
                            <motion.p initial={{ x: -200, opacity: 0 }} animate={{ x: 0, opacity: 100 }} transition={{ duration: 1, delay: 0.1 }} className='mt-7 xl:max-w-[40rem] lg:max-w-[30rem] max-w-[40rem] font-poppins lg:text-md sm:text-sm text-xs px-10 lg:px-0 2xl:text-lg'>As you are likely aware, Google has recently announced the forthcoming launch of their ChatGPT artificial intelligence competitor, dubbed "Bard." This initiative, built on the Ethereum Blockchain, leverages Google's cutting-edge AI technology to create compelling AI bots for use on popular platforms such as Telegram and Discord. It is anticipated that this will become the largest AI token on the Ethereum network, reflecting the vibrant and innovative nature of AI technology. We believe that our efforts in the cryptocurrency space will be recognized by Google as a valuable contribution to their ongoing work in this field.</motion.p>

                            <motion.div initial={{ x: -200, opacity: 0 }} animate={{ x: 0, opacity: 100 }} transition={{ duration: 1, delay: 0.15 }} className='flex gap-x-3 md:flex-row flex-col items-center mt-10 gap-y-4'>
                                <button className='bg-button px-12 py-3 w-fit h-fit rounded-lg hover:bg-[#040B9E] cursor-pointer z-10 relative transition-colors ease-in-out duration-300 mx-auto lg:mx-0 font-poppins'>
                                    <p>Buy Token</p>
                                </button>

                                <button className='bg-[#A5ADBC] px-12 py-3 w-fit h-fit rounded-lg hover:bg-white hover:text-black font-medium cursor-pointer z-10 relative transition-colors ease-in-out duration-300 mx-auto lg:mx-0 font-poppins text-hero'>
                                    <p>Charts</p>
                                </button>
                            </motion.div>
